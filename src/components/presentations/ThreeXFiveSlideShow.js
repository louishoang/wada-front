...
class ThreeXFiveSlideShow extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div className="three-x-five-slider fit-content-height">
...
ThreeXFiveSlideShow.defaultProps = {
  list: []
}

ThreeXFiveSlideShow.propTypes = {
  list: PropTypes.arrayOf(PropTypes.object).isRequired
}

export default ThreeXFiveSlideShow